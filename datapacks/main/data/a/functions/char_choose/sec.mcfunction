scoreboard players set @a[tag=player] str 8
scoreboard players set @a[tag=player] dex 8
scoreboard players set @a[tag=player] agi 8
scoreboard players set @a[tag=player] con 8
scoreboard players set @a[tag=player] wil 8
scoreboard players set @a[tag=player] int 8
scoreboard players set @a[tag=player] men 8
scoreboard players set @a[tag=player] luk 8

tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n能力值更改為：","color":"gold"},{"text":"★歷練過的亞加","color":"light_purple"}]
...
data merge entity @e[tag=mental,limit=1] {CustomName:"{\"text\":\"充滿決心\"}"}