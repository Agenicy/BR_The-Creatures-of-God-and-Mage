scoreboard players set @a[tag=player] str 3
scoreboard players set @a[tag=player] dex 3
scoreboard players set @a[tag=player] agi 3
scoreboard players set @a[tag=player] con 3
...
scoreboard players set @a[tag=player] luk 5
