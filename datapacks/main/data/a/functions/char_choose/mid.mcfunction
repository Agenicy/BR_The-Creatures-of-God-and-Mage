...
scoreboard players set @a[tag=player] dex 1
scoreboard players set @a[tag=player] agi 1
scoreboard players set @a[tag=player] wil 1
scoreboard players set @a[tag=player] int 1
scoreboard players set @a[tag=player] men 1
scoreboard players set @a[tag=player] con 1
scoreboard players set @a[tag=player] luk 1
