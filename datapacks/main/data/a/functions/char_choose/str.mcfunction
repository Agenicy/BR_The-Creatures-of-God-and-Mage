scoreboard players set @a[tag=player] str 2
scoreboard players set @a[tag=player] dex 2
scoreboard players set @a[tag=player] agi 2
scoreboard players set @a[tag=player] wil 0
scoreboard players set @a[tag=player] int 0
scoreboard players set @a[tag=player] men 0
scoreboard players set @a[tag=player] con 2
scoreboard players set @a[tag=player] luk 0

tellraw @a [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n能力值更改為：","color":"gold"},{"text":"物理型","color":"aqua"}]
