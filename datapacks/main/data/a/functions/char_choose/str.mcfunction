...
scoreboard players set @a[tag=player] wil 3
scoreboard players set @a[tag=player] int 3
scoreboard players set @a[tag=player] men 3
scoreboard players set @a[tag=player] luk 3
