...
tellraw @a[scores={st=2,check_success=1}] {"text":"→［成功］看來相信卡司是正確的。","color":"aqua","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set 46"}}
tellraw @a[scores={st=2,check_success=0}] {"text":"→［失敗］糟糕、踢到石頭了！","color":"aqua","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set 44"}}
