...
execute if entity @a[tag=player,scores={st=1}] run function a:dia/ch1_1/func/pass
...
tellraw @a[scores={st=3}] {"text":"→［通過獎勵］精神+1","color":"aqua","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set "}}
