...
execute if entity @a[tag=player,scores={st=1}] run function a:ch1_1/func/battle
...
execute if entity @a[tag=player,scores={st=8}] run function a:ch1_1/func/battle_fin
