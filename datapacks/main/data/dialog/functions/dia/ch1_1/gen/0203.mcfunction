...
execute if score @a[tag=player,limit=1] st matches 1 run scoreboard players set @a[tag=player] check_target 13
...
execute if entity @a[tag=player,scores={st=2}] run function dialog:dia/ch1_1/func/husk_move_or_not
