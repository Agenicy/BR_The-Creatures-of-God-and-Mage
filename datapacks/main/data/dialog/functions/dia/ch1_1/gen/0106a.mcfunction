...
tellraw @a[scores={st=4}] {"text":"【當前目標】準備好後，與卡司對話","clickEvent":{"action":"run_command","value":"/function dialog:dia/add"}}
execute if entity @a[tag=player,scores={st=4}] run function dialog:dia/ch1_1/func/continue
...
execute if entity @a[tag=player,scores={st=4}] run function dialog:dia/fin
