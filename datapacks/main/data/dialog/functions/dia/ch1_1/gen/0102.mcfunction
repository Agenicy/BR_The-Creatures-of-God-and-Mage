...
tellraw @a[scores={st=1}] {"text":"→［力量／簡單］徒手破壞吧！（受傷風險）","color":"aqua","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set 5"}}
