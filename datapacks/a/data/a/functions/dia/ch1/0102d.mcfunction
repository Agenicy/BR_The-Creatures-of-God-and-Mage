...
tellraw @a[tag=player,scores={st=6}] {"text":"→〔成功〕通過鐵柵欄","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set 24"}}24
