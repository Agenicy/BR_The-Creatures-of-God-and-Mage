...
tellraw @a[tag=player,scores={st=1}] {"text":"→〔成功〕果然，我還是做不到任何事……","clickEvent":{"action":"run_command","value":"/execute store success score @s dia_st run trigger dia_choose set 24"}}24
