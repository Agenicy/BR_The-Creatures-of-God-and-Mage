...
tellraw @a[tag=player,scores={st=2,check_success=1}] {"text":"→〔成功〕呼……我們做到了！","clickEvent":{"action":"run_command","value":"#N/A#N/A
tellraw @a[tag=player,scores={st=2,check_success=0}] {"text":"→〔任務失敗〕被抓住了……","clickEvent":{"action":"run_command","value":"#N/A#N/A
